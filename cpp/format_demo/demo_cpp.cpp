    ...
    try {
        ...
        while (true) {
            ...
            try {
                ...
                // 【修改】通过 vector 添加多个越界规则。规则名称（如 line_1, line_2 等）将在 Processor 内部自动生成。
                proc_config.line_rules_spec[CAM_ID] = {
                    {{1400, 1280}, {1200, 60}, "any", -1}, // 示例1: 一条竖线
                    {{2000, 700}, {1000, 700}, "BA", 10}  // 示例2: 一条横线
                };
