...
if __name__ == '__main__':
    ...
    print('开始从 {} 张BMP图片中提取特征...'.format(len(bmp_paths_sorted)))
    feats = extract_features_in_batch(reid, bmp_paths_sorted)  # (N, D)

    output_txt_path = '/home/manu/tmp/features.txt'
    print('\n正在将特征保存到 "{}"...'.format(output_txt_path))
    ...
    print('  - 提取的特征文件位于: {}'.format(os.path.abspath(output_txt_path)))
    print('==============================================')
