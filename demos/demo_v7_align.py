...
from demos.demo_v7 import draw_boundaries, BOUNDARY_CONFIG
...
RAW_DIR = "/home/manu/tmp/cache_v4"
CACHE_PATH = '/home/manu/tmp/features_cache_v4.json'
OVERWRITE = SAVE_RAW
...
def main():
    ...
    try:
        while True:
            ...
            draw_boundaries(vis, CAM_ID, simple_display=False)
